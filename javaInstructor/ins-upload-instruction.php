...
<div class="wrapper">
    ...
    text-transform: uppercase"><i class="ti-book"></i>Course Management</a>
                    <ul id="subcourse" class="collapse">
                        <li class="hide-dot active"><a href="ins-upload-instruction.php">Upload Instruction</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control border-input">
                                                    ...
                                                    <option value="201">CSC 201</option>
                                                    <option value="202">CSC 202</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" rows="6" class="form-control border-input" placeholder="Type course instruction here...">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Preview the instruction before final submission</p>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"><b>Uploaded Instructions</b></h4>
                                <p class="category">You may edit or delete instructions</p>
                            </div>
