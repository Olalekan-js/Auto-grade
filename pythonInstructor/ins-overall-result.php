...
<head>
	...
	<title>Overall Result- AutoGrade</title>
...
<div class="wrapper">
    ...
    text-transform: uppercase"><i class="ti-user"></i>Student Management</a>
                    <ul id="submenu" class="collapse">
                        ...
                        <li class="hide-dot active"><a href="ins-overall-result.php">View Result</a></li>
                    </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="Computer Science and Engineering">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd">View Overall Result</button>
                                    </div>
